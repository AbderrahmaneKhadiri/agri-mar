...
export default function MarketplaceProductsPage() {
    ...
    const handleViewProfile = async (farmerId: string) => {
        if (!farmerId || isLoadingProfile) return;
        setIsLoadingProfile(true);
        const result = await getFarmerProfileByIdAction(farmerId);
        if (result.success) {
                            ...
                            >
                                ...
                                <CardContent className="p-4 space-y-4">
                                    ...
                                    <div className="pt-2 flex flex-col gap-2">
                                        ...
                                        >
                                            {isContacting === product.id ? <Loader2 className="size-4 animate-spin" /> : "Contacter le vendeur"}
                                        </Button>
                                    </div>
                                </CardContent>
                            </Card>
